...
module ActsAsXapian
  ...
  mattr_reader :db
  mattr_reader :db_path
  mattr_reader :writable_db
  mattr_reader :stemmer
  mattr_reader :term_generator
  mattr_reader :enquire
  mattr_reader :query_parser
  mattr_reader :values_by_prefix
  mattr_reader :config
  ...
  def ActsAsXapian.rebuild_index(model_classes, verbose = false)
    raise "when rebuilding all, please call as first and only thing done in process / task" unless ActsAsXapian.writable_db.nil?
